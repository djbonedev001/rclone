...
func (f *Fs) DirMove(ctx context.Context, src fs.Fs, srcRemote, dstRemote string) error {
	...
	// FIXME due to a bug I presume the dir move doesn't work at 1fichier giving
	// {"status":"KO","message":"Internal Error #693"}
	// If this gets fixed then remove this if statement
	if doMove {
		fs.Debugf(srcFs, "Can't move directory between folders")
		return fs.ErrorCantDirMove
	}
